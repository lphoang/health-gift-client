...
import { getAllAppointmentsByDoctorId, updateStatus } from 'features/slices/appointmentSlice';
import { AppointmentStatus, AppointmentType, IAppointmentResponse } from 'utils/types';
...
function DocCalendar() {
    ...
    useEffect(() => {
        dispatch(getAllAppointmentsByDoctorId(id, token))
    ...
    appointments.map((app: IAppointmentResponse) => {
