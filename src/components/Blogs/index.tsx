            ...
            <div className='flex max-w-xl my-10 bg-white shadow-md rounded-lg overflow-hidden mx-auto'>
                <div className='flex items-center w-full'>
                    <div className='w-full'>
                        ...
                        <div className='text-gray-400 font-medium text-sm mb-7 mt-6 mx-3 px-2'><img className="rounded" src="https://picsum.photos/536/354" alt="" /></div>
                        ...
                        <div className="relative flex items-center self-center w-full max-w-xl p-4 overflow-hidden text-gray-600 focus-within:text-gray-400">
                            ...
                            <input type="search" className="w-full py-2 pl-4 pr-10 text-sm bg-gray-100 border border-transparent appearance-none rounded-tg placeholder-gray-400 focus:bg-white focus:outline-none focus:border-blue-500 focus:text-gray-900 focus:shadow-outline-blue" placeholder="Post a comment..." />
                        </div>
                    </div>
                </div>
            </div>
